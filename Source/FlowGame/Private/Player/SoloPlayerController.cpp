...
#include "FlowGameSettings.h"
#include "UI/QuestUIManager.h"

#include "EnhancedInputComponent.h"
#include "EnhancedInputSubsystems.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(SoloPlayerController)
...
void ASoloPlayerController::ActivateInteraction(const TWeakObjectPtr<UInteractionComponent> Interaction)
{
	...
	GetGameInstance()->GetSubsystem<UQuestUIManager>()->OpenWidget(GetDefault<UFlowGameSettings>()->InteractionWidget);
}

void ASoloPlayerController::DeactivateInteraction()
{
	ActiveInteraction = nullptr;
	GetGameInstance()->GetSubsystem<UQuestUIManager>()->CloseWidget(GetDefault<UFlowGameSettings>()->InteractionWidget);
}
